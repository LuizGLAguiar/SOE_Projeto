...
int main(int argc, char *argv[])
{
	...
	int fd = open("/home/aguiar/Desktop/SOE_Projeto/sources/dados.txt", O_WRONLY | O_APPEND | O_CREAT, S_IRUSR | S_IWUSR);
	if(fd == -1)
	{
	...
	std::ifstream file("/home/aguiar/Desktop/SOE_Projeto/sources/files/coco.names");
	std::string line;
	while (std::getline(file, line)) {
		classes.push_back(line);
	}

	Net net = readNetFromDarknet("/home/aguiar/Desktop/SOE_Projeto/sources/files/yolov4.cfg", "/home/aguiar/Desktop/SOE_Projeto/sources/files/yolov4.weights");
	...
	for(int i = 1; i < argc; i++)
	{
		...
		media += classIds.size();
		char filename[100];
		sprintf(filename,"/home/aguiar/Desktop/SOE_Projeto/photos/pics_analyzed/foto_%d.jpg", i);
